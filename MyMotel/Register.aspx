...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <br /><asp:CompareValidator ID="SecurityQuestionCompareValidator" runat="server" ControlToCompare="ddlSecurityQuestion1"
                            ...
                            ValueToCompare="0"
                            ErrorMessage="Please select differant question." ValidationGroup="RegisterUserValidationGroup1"></asp:CompareValidator>
        ...
        <p style="text-align: center;">
            ...
            <asp:Button ID="btnBack1" runat="server" Text="Back" OnClientClick="window.history.back();" CssClass="button" Font-Bold="True" />
                <asp:Button ID="btnBack" runat="server" Text="Back" Visible="false" OnClick="btnBack_Click" CssClass="button" />
